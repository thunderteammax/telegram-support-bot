...
WELCOME_MESSAGE = os.getenv("WELCOME_MESSAGE", "Hey There I can Promote Your YouTube Channel Before That You have to send me Your Details. Channel Name :- Channel Link :- Email :- Your Explanation :- ")
